...
# De co the xoa duoc /KMA2 thi minh can phai chmod 777 / -> gan full quyen cho thu muc goc thi mo co the xoa file trong thu muc goc, group root khong
 xoa duoc file, chi co the doc va thuc thi file